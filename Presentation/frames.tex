...
\node[opacity=2, inner sep=0pt, rotate=90]
    at(210pt,-10pt){\includegraphics[width=6cm]{resources/bresenham.png}};
\node[opacity=1, inner sep=0pt]
    at(350pt,-5pt){\includegraphics[width=4.7cm]{resources/tunneling.png}};
\end{tikzpicture}
