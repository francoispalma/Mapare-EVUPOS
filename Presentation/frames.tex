...
\node[opacity=2, inner sep=0pt]
    at(210pt,-10pt){\includegraphics[width=3.5cm]{resources/bresenham.png}};
\node [label={[xshift=210pt, yshift=-125pt]Bresenham}];

\node[opacity=1, inner sep=0pt]
    at(350pt,-5pt){\includegraphics[width=4cm]{resources/tunneling.png}};
\node [label={[xshift=350pt, yshift=-125pt]Couverture \& Tunnel}];
\end{tikzpicture}
